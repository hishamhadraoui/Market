<div class="col-lg-3 content-left">
        ...
        <div class="categories list-group hidden-xs hidden-sm hidden-md">
            ...
            <a href="#" class="list-group-item">Cameras & Photo </a>
            <a href="#" class="list-group-item">Cell Phones & Accessories </a>
            <a href="#" class="list-group-item">Clothing, Shoes & Accessories </a>
            <a href="#" class="list-group-item">Computers & Networking </a>
            <a href="#" class="list-group-item">DVDs & Movies </a>
        ...
        <div class="hidden-xs hidden-sm hidden-md">
            ...
            <div class="newest-classifieds">
                ...
                <p class="text-right show-more"><a href="#">Voir plus &rarr;</a></p>
            </div>
        </div>
    </div>